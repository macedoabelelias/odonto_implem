...
<div id="content" style="margin-top: -20px; margin-bottom: 30px">
	<table id="" style="border-style: solid; font-size: 9px; margin-bottom:10px; width: 100%; table-layout: fixed; margin-top:0px;">
			<thead>
				...
				<tr >
					<td style="width:5%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><b>NOME: </b></td>
					<td style="width:35%; border-right: : 1px solid #000; border-bottom: : 1px solid #000;">
						<?php echo mb_strtoupper($nome_paciente) ?>
					</td>
					
					<td style="width:5%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><b>CPF: </b></td>
					<td style="width:13%; border-bottom: : 1px solid #000; border-right: 1px solid #000;">
						<?php echo mb_strtoupper($cpf_paciente) ?>
					</td>
					<td style="width:9%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><b>TELEFONE: </b></td>
					<td style="width:13%; border-bottom: : 1px solid #000; border-right: 1px solid #000;">
						<?php echo mb_strtoupper($telefone_paciente) ?>
					</td>
					<td style="width:5%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><b>GÊNERO: </b> </td>
					<td style="width:5%; border-bottom: : 1px solid #000;">
						<?php echo mb_strtoupper($sexo) ?>
					</td>
    			</tr>
    			<tr >
					<td style="width:8%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><b>CONVÊNIO: </b></td>
					<td style="width:30%; border-right: : 1px solid #000; border-bottom: : 1px solid #000;">
						<?php echo mb_strtoupper($nome_convenio) ?>
					</td>
					
					<td style="width:5%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><b>IDADE: </b></td>
					<td style="width:11%; border-bottom: : 1px solid #000; border-right: 1px solid #000;">
						<?php echo mb_strtoupper($idade) ?> Anos
					</td>
					<td style="width:10%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><b>NASCIMENTO: </b></td>
					<td style="width:13%; border-bottom: : 1px solid #000; border-right: 1px solid #000;">
						<?php echo mb_strtoupper($data_nascF) ?>
					</td>
					<td style="width:13%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><b>TIPO SANGUÍNEO: </b></td>
					<td style="width:5%; border-bottom: : 1px solid #000;">
						<?php echo mb_strtoupper($tipo_sanguineo) ?>
					</td>
    			</tr>
    			<tr >
					<td style="width:8%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><b>PROFISSÃO: </b></td>
					<td colspan="3" style="width:30%; border-right: : 1px solid #000; border-bottom: : 1px solid #000;">
						<?php echo mb_strtoupper($profissao) ?>
					</td>
					
					
					<td style="width:10%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><b>ESTADO CIVIL: </b></td>
    			...
    			<tr >
					...
					<td colspan="3" style="width:13%; border-right: : 1px solid #000; border-bottom: : 1px solid #000;">
						<?php echo mb_strtoupper($endereco_paciente) ?>
					</td>

					<td style="width:8%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><b>OBS </b></td>
					<td colspan="3" style="width:30%; border-bottom: : 1px solid #000;">
    			...
    			<?php if($nome_responsavel != ""){ ?>
    				<tr >
					<td style="width:8%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><b>RESP </b></td>
					<td colspan="3" style="width:30%; border-right: : 1px solid #000; border-bottom: : 1px solid #000;">
						<?php echo mb_strtoupper($nome_responsavel) ?>
					</td>
					
					
					<td style="width:10%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><b>CPF RESP: </b></td>
					<td colspan="3" style="width:13%; border-bottom: : 1px solid #000;">
