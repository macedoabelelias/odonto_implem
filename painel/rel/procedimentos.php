		...
		<table id="cabecalhotabela" style="border-bottom-style: solid; font-size: 10px; margin-bottom:10px; width: 100%; table-layout: fixed;">
			<thead>
				...
				<tr id="cabeca" style="margin-left: 0px; background-color:#CCC">
					...
					<td style="width:10%">EXECUTADO</td>
...
<td style="width:40%; color:<?php echo $classe_exame ?>"><?php echo $nome ?></td>
...
<td style="width:10%"><?php echo $dias_retorno ?> Vezes</td>
<td style="width:10%"><?php echo $executado ?> Dias</td>
    </tr>
<?php } } ?>
				</tbody>
