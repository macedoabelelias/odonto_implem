...
$retornos_servicos = 'ocultar';
$rel_servicos_executados = 'ocultar';
...
if($total_reg > 0){
	for($i=0; $i < $total_reg; $i++){
		...
		if($chave == 'retornos_servicos'){
			$retornos_servicos = '';
		}

		if($chave == 'rel_servicos_executados'){
			$rel_servicos_executados = '';
		}
...
if($usuarios == 'ocultar' and $funcionarios == 'ocultar' and $fornecedores == 'ocultar' and $clientes == 'ocultar' and $aniversariantes == 'ocultar'){
...
if($agendamentos == 'ocultar' and $rel_agendamentos == 'ocultar' and $rel_procedimentos == 'ocultar' and $retornos_servicos == 'ocultar' and $rel_servicos_executados == 'ocultar'){
