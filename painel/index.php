...
<?php 
							$dataMes = Date('m');
									$dataDia = Date('d');	
							$query = $pdo->query("SELECT * FROM clientes where month(data_nasc) = '$dataMes' and day(data_nasc) = '$dataDia' order by data_nasc asc, id desc");
							...
							?>
									<li class="dropdown nav-item  main-header-message <?php echo $aniversariantes ?>">
										<a class="new nav-link" data-bs-toggle="dropdown" href="javascript:void(0);">
											<small><i class="fa fa-birthday-cake"></i></small>
											<span class="badge  header-badge" style="background:#a66b0d"><?php echo $total_reg ?></span>
										</a>
										...
										<div class="dropdown-menu">
											<div class="menu-header-content text-start border-bottom">
												<div class="d-flex">
													<h6 class="dropdown-title mb-1 tx-15 font-weight-semibold">Aniversariante(s) Hoje</h6>

												</div>
												<p class="dropdown-title-text subtext mb-0 op-6 pb-0 tx-12 "><?php echo $total_reg ?> Aniversariantes!</p>
											</div>
											<div class="main-message-list chat-scroll">

												<?php 
								$query = $pdo->query("SELECT * FROM clientes where month(data_nasc) = '$dataMes' and day(data_nasc) = '$dataDia' order by data_nasc asc, id desc limit 12");
								$res = $query->fetchAll(PDO::FETCH_ASSOC);
									...
									for($i=0; $i<$pagar_vencidas; $i++){		
										?>
													...
													<a href="aniversariantes" class="dropdown-item d-flex border-bottom">
														...
														<div class="wd-90p">
															<div class="d-flex">
																<h5 class="mb-0 name"><i class="fa fa-check"></i> <?php echo $res[$i]['nome'] ?></h5>
															</div>
						...
						<ul class="side-menu">
							...
							<li class="slide <?php echo @$menu_pessoas ?>">
								...
								<ul class="slide-menu">
									...
									<li class="<?php echo @$aniversariantes ?>"><a class="slide-item" href="aniversariantes"> Aniversariantes</a>
									</li>
							...
							<li class="slide <?php echo @$menu_cadastros ?>">
								...
								<ul class="slide-menu">
									...
									<li class="<?php echo @$retornos_servicos ?>"><a class="slide-item" href="retornos_servicos"> Retornos Alertas</a></li>


									<li class="<?php echo @$rel_servicos_executados ?> "><a class="slide-item" href="" data-bs-toggle="modal" data-bs-target="#modalRelServExe">Procedimentos Executados</a></li>
					...
					<div class="row mb-3">
						...
						<div class="col-md-2">
							...
							<div class="form-group">
								...
								<input class="form-control" type="file" name="fundo_login"
									onChange="carregarImgFundo();" id="fundo_login">
							</div>
						</div>
						<div class="col-md-2">
							<div id="divImg">
								<img src="../img/<?php echo $fundo_login ?>" width="80px" id="target-fundo">
								<a title="Excluir Imagem" href="#" onclick="excluirImg('Fundo')"><i
...
<!-- Modal Rel servicos mais executados -->
<div class="modal fade" id="modalRelServExe" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title" id="exampleModalLabel">Relatório de Procedimentos Mais Executados</h4>
            ...
            <form method="POST" action="rel/servicos_mais_executados_class.php" target="_blank">
                <div class="modal-body">    
