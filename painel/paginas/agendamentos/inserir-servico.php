...
$dias = $res[0]['dias_retorno'];
$executado = $res[0]['executado'];
$data_retorno = date('Y-m-d', strtotime("+$dias days", strtotime($data_atual)));
...
$pdo->query("UPDATE agendamentos SET pago = '$foi_pago', tipo_pagamento = '$pgto', valor = '$valor_serv', convenio = '$convenio', numero_convenio = '$numero_convenio', data_retorno_alerta = '$data_retorno' where id = '$id_agd'");
...
$servicos_novo = $executado + 1;
		//adicionar os produtos na tabela produtos
$pdo->query("UPDATE procedimentos SET executado = '$servicos_novo' WHERE id = '$servico'");
